...
import fun.domain.vote.query.MedalQueryRepository;
import fun.domain.vote.query.MemberQueryRepository;
import fun.domain.vote.query.VoteLabelQueryRepository;
import fun.domain.vote.query.VotePostQueryRepository;
